...
root.configure(bg='Light Green') #powder blue
...
Bot_Text = Message(Bot_Frame, text="", width='500', font=(
    "Helevetica", 10, "bold"), bg=root['bg'], fg="black") # white
...
Label(Name_Frame, text="Medicine Name : ", font=(
    "Verdana", 15), bg=root['bg'], fg='grey').place(x=0)
...
Label(Schedule_Frame, text="Listen Schedule : ", font=(
    "Verdana", 15), bg=root['bg'], fg='grey').place(y=0)
...
Label(Schedule_Frame, text="Morning : ", font=(
    "Verdana", 15), bg=root['bg'], fg='grey').place(y=50)
...
Label(Schedule_Frame, text="Afternoon : ", font=(
    "Verdana", 15), bg=root['bg'], fg='grey').place(y=100)
...
Label(Schedule_Frame, text="Evening : ", font=(
    "Verdana", 15), bg=root['bg'], fg='grey').place(y=150)
